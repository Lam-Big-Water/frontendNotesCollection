...
![flexbox-rule](./screencut/flexbox-rules.png);

5. justify-content & align-items

![content&items](./screencut/content&items.png);
...
![align-self](./screencut/align-self.png);
...
![primary-axis](./screencut/primary-axis.png);
![cross-axis](./screencut/cross-axis.png);

each item can move along its stick without interfering with any of the other items:
![cross-axis-move](./screencut/cross-axis-move.png);

 a single item can’t move along its stick without bumping into its siblings! 
![primary-axis-move](./screencut/primary-axis-move.png);
...
![hypothetical-size](./screencut/Hypothetical-size.png);
...
![flex-basis](./screencut/flex-basis.png);
...
![flex-grow-default](./screencut/flex-grow-default.png);


![flex-grow-1](./screencut/flex-grow-1.png);

What if multiple children set flex-grow?

![flex-grow-divided](./screencut/flex-grow-divided.png);
...
![flex-shrink](./screencut/flex-shrink.png);
...
![flex-shrink-proportionally](./screencut/flex-shrink-proportionally.png);
...
![flex-shrink-0](./screencut/flex-shrink-0.png);
...
![minimum-size](./screencut/minimum-size.png)
...
![unbreakable-characters](./screencut/unbreakable-characters.png)
...
![min-width](./screencut/min-width.png)
...
![caution](./screencut/proceed-with-caution.png)

11. Gaps

gap allows us to create space in-between each Flex child.

![gap](./screencut/gap.png);
...
![auto-margins](./screencut/auto-margins.png);
...
![wrapping](./screencut/wrapping.png)

![multi-axis](./screencut/multi-axis.png)
...
![wrap-align-items](./screencut/wrap-align-items.png)

But what if we want to align the rows themselves? We can do that with the align-content property:

![wrap-align-content](./screencut/wrap-align-content.png)
